...
public class MinerDeadlinesRecord extends UpdatableRecordImpl<MinerDeadlinesRecord> implements Record7<Long, Long, Long, Long, Long, Integer, Double> {
     ...
     */
    @Override
    public Row7<Long, Long, Long, Long, Long, Integer, Double> fieldsRow() {
     ...
     */
    @Override
    public Row7<Long, Long, Long, Long, Long, Integer, Double> valuesRow() {
     ...
     */
    @Override
    public MinerDeadlinesRecord values(Long value1, Long value2, Long value3, Long value4, Long value5, Integer value6, Double value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MinerDeadlinesRecord(Long dbId, Long accountId, Long height, Long deadline, Long baseTarget, Integer sharePercent, Double commitmentFactor) {
        super(MinerDeadlines.MINER_DEADLINES);
